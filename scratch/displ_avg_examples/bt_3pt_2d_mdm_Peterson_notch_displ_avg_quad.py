...
#    ibvpy_app.main()             stress_state="plane_strain",
    ...
    fets_eval = FETS2D4Q8U(mats_eval=mdm)
...
#                                                        correction=True))
    ...
    redundant_dof = fe_grid[n_el_x / 2., 0, 1, 0].dofs.flatten()
    print 'redundant_dof' , redundant_dof
...
#              u_processor=avg_processor,
             bcond_list=[
                        ...
                        BCSlice(var='u', slice=fe_grid[n_el_x / 2., 0, 1, 0], dims=[0, 1], value=0.),
